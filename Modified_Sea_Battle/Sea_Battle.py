...
class Player:
    def __init__(self, name):
        ...
        self.ships = [Ship(4), Ship(3)]  # Two ships of sizes 4 and 3
    ...
    while True:
        ...
        while any(not ship.is_sunk() for ship in player.ships):
            ...
            if player.board[row][col] == ' ':
                ...
                player.ships[ship_size - 4].hits += 1  # Adjust index for ship sizes 4 and 3
                player.board[row][col] = 'X'
                if player.ships[ship_size - 4].is_sunk():  # Adjust index for ship sizes 4 and 3
                    result = 'sunk'
                else:
                    result = 'hit'
